...
DEFAULT_RAW_MATERIALS = [
    ("bread", "Bread", 100, "slices"), ("tomato", "Tomato", 100, "pieces"), ("potato", "Potato", 30, "kg"),
    ("pasta", "Pasta", 15, "kg"), ("carrot", "Carrot", 15, "kg"), ("cheese", "Cheese", 10, "kg"),
    ("rice", "Rice", 50, "kg"), ("onion", "Onion", 25, "kg"), ("paneer", "Paneer", 12, "kg"),
    ("lentils", "Lentils", 25, "kg"), ("flour", "Flour", 40, "kg"), ("oil", "Oil", 20, "litres"),
]
DEFAULT_RECIPES = {
...
def add_raw_material():
    ...
    db.collection("raw_materials").document(material_id).set({
